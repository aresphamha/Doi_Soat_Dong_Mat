...
async def main():
    print("==================================================")
    print("TOOL SPAM TELEGRAM - PHIẾU CẦN HẬU KIỂM THỊT CÁ")
    print("==================================================")
    ...
    if len(df_tickets) == 0:
        print("Tuyệt vời! Không có phiếu chuyển THỊT CÁ nào đang treo ở trạng thái 'Cần hậu kiểm' trong hôm nay.")
        input("Bấm Enter để thoát...")
        sys.exit()
...
{tag_text}'''
        ...
        try:
            ...
            # Fix ratio if it exceeds Telegram limits (width/height > 20)
