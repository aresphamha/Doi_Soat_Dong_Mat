...
WHERE branch_name LIKE '%CHÊNH LỆCH%' OR branch_name LIKE '%RAU CỦ%'
"""
df = fetch_data_to_df(sql)
with open('C:\\Users\\PC\\Desktop\\AI\\Đối soát\\THỊT CÁ\\check_chenhlech.txt', 'w', encoding='utf-8') as f:
    f.write(str(df))
